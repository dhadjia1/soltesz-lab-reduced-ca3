...
#define _f_exptable _f_exptable_GLU
#define exptable exptable_GLU
...
#define Cmax Cmax_GLU
 double Cmax = 1;
#define Deadtime Deadtime_GLU
 double Deadtime = 0;
#define Erev Erev_GLU
 double Erev = 0;
#define Prethresh Prethresh_GLU
 double Prethresh = 0;
#define Rtau Rtau_GLU
 double Rtau = 0;
#define Rinf Rinf_GLU
 double Rinf = 0;
#define usetable usetable_GLU
 double usetable = 1;
 ...
 "Beta_GLU", &Beta_GLU,
 "Erev_GLU", &Erev_GLU,
 "Prethresh_GLU", &Prethresh_GLU,
 "Deadtime_GLU", &Deadtime_GLU,
 "Rinf_GLU", &Rinf_GLU,
 "Rtau_GLU", &Rtau_GLU,
 "usetable_GLU", &usetable_GLU,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "pointer");
 	...
 	ivoc_help("help ?1 GLU /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/glutamate.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("GLU", "cannot be used with CVODE"); return 0;}
...
{
 { error =  release();
 if(error){fprintf(stderr,"at line 142 in file glutamate.mod:\n	SOLVE release\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/glutamate.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "-----------------------------------------------------------------------------\n"
