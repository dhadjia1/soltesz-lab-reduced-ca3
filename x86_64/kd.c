...
#define taun taun_kd
 double taun = 0;
#define vhalfn vhalfn_kd
 double vhalfn = -33;
#define zetan zetan_kd
 double zetan = 3;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kd /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/kd.mod\n");
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 44 in file kd.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/kd.mod";
static const char* nmodl_file_text = 
  "TITLE  K-D channel\n"
  ": M.Migliore jun 2006\n"
  "\n"
