...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "ca_ion");
 	...
 	ivoc_help("help ?1 ch_KCaS /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/ch_KCaS.mod\n");
 ...
 v=_v;
{
  ...
  cai = _ion_cai;
 { error =  state();
 if(error){fprintf(stderr,"at line 62 in file ch_KCaS.mod:\n	SOLVE state\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/ch_KCaS.mod";
static const char* nmodl_file_text = 
