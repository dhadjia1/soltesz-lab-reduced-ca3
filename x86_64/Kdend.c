...
#define nrn_init _nrn_init__Kdend
#define _nrn_initial _nrn_initial__Kdend
#define nrn_cur _nrn_cur__Kdend
#define _nrn_current _nrn_current__Kdend
#define nrn_jacob _nrn_jacob__Kdend
#define nrn_state _nrn_state__Kdend
#define _net_receive _net_receive__Kdend 
#define _f_evaluate_fct _f_evaluate_fct__Kdend 
#define evaluate_fct evaluate_fct__Kdend 
#define states states__Kdend 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_Kdend", _hoc_setdata,
 "Exp_Kdend", _hoc_Exp,
 "evaluate_fct_Kdend", _hoc_evaluate_fct,
 "states_Kdend", _hoc_states,
 "vtrap_Kdend", _hoc_vtrap,
 0, 0
};
#define Exp Exp_Kdend
#define vtrap vtrap_Kdend
 extern double Exp( double );
 extern double vtrap( double , double );
 /* declare global and static user variables */
#define ntau ntau_Kdend
 double ntau = 0;
#define nexp nexp_Kdend
 double nexp = 0;
#define ninf ninf_Kdend
 double ninf = 0;
#define usetable usetable_Kdend
 double usetable = 1;
 ...
 "ninf_Kdend", &ninf_Kdend,
 "nexp_Kdend", &nexp_Kdend,
 "ntau_Kdend", &ntau_Kdend,
 "usetable_Kdend", &usetable_Kdend,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "k_ion");
 	...
 	ivoc_help("help ?1 Kdend /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/Kdend.mod\n");
...
static int  _f_evaluate_fct (  double _lv ) {
 ...
 _lq10 = 1.0 ;
   _ltinc = - dt * _lq10 ;
   _lalpha = 0.018 * vtrap ( _threadargscomma_ - ( _lv - 20.0 ) , 21.0 ) ;
   _lbeta = 0.0036 * vtrap ( _threadargscomma_ _lv - 30.0 , 12.0 ) ;
   ntau = 1.0 / ( _lalpha + _lbeta ) ;
   ninf = _lalpha * ntau ;
   nexp = 1.0 - Exp ( _threadargscomma_ _ltinc / ntau ) ;
    return 0; }
...
static int _ode_count(int _type){ hoc_execerror("Kdend", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 43 in file Kdend.mod:\n        SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/Kdend.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
