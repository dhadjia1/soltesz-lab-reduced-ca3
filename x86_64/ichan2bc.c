...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 8, "ks_ion");
 	...
 	ivoc_help("help ?1 ichan2bc /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/ichan2bc.mod\n");
...
static int _reset;
static char *modelname = "ichan2bc.mod  ";
...
static int  rates (  double _lv ) {
 ...
 _zq10 = 1.0 ;
   ...
   _lbeta = 0.264 / exp ( ( _lv + 65.0 - 55.0 ) / 35.0 ) ;
   _lsum = _lalpha + _lbeta ;
   nftau = 1.0 / _lsum ;
   nfinf = _lalpha / _lsum ;
    return 0; }
 ...
 v=_v;
{
  ...
  eks = _ion_eks;
 { error =  states();
 if(error){fprintf(stderr,"at line 72 in file ichan2bc.mod:\n    SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 }   }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/ichan2bc.mod";
static const char* nmodl_file_text = 
  "TITLE ichan2bc.mod  \n"
  " \n"
  "COMMENT\n"
