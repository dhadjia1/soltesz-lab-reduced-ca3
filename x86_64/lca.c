...
static void _check_alp(double*, Datum*, Datum*, _NrnThread*); 
static void _check_bet(double*, Datum*, Datum*, _NrnThread*); 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 lca /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/lca.mod\n");
...
static void _hoc_efun(void) {
 ...
 static double _mfac_alp, _tmin_alp;
  static void _check_alp(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
 ...
 double alp(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _lv) { 
#if 0
_check_alp(_p, _ppvar, _thread, _nt);
#endif
 ...
 static double _n_alp(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _lv){ int _i, _j;
 double _xi, _theta;
 if (!usetable) {
...
static void _hoc_alp(void) {
 ...
 static double _mfac_bet, _tmin_bet;
  static void _check_bet(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
  static int _maktable=1; int _i, _j, _ix = 0;
  double _xi, _tmax;
  if (!usetable) {return;}
  if (_maktable) { double _x, _dx; _maktable=0;
 ...
 double bet(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _lv) { 
#if 0
_check_bet(_p, _ppvar, _thread, _nt);
#endif
 ...
 static double _n_bet(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _lv){ int _i, _j;
 double _xi, _theta;
 if (!usetable) {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/lca.mod";
static const char* nmodl_file_text = 
