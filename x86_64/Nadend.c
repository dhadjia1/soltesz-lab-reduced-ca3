...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "na_ion");
 	...
 	ivoc_help("help ?1 Nadend /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/Nadend.mod\n");
 ...
 v=_v;
{
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 84 in file Nadend.mod:\n        SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/Nadend.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
