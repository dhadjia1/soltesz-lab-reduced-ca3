...
#define nrn_init _nrn_init__can_CA3
#define _nrn_initial _nrn_initial__can_CA3
#define nrn_cur _nrn_cur__can_CA3
#define _nrn_current _nrn_current__can_CA3
#define nrn_jacob _nrn_jacob__can_CA3
#define nrn_state _nrn_state__can_CA3
#define _net_receive _net_receive__can_CA3 
#define rates rates__can_CA3 
#define states states__can_CA3 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_can_CA3", _hoc_setdata,
 "KTF_can_CA3", _hoc_KTF,
 "alpmt_can_CA3", _hoc_alpmt,
 "alpm_can_CA3", _hoc_alpm,
 "alph_can_CA3", _hoc_alph,
 "betmt_can_CA3", _hoc_betmt,
 "betm_can_CA3", _hoc_betm,
 "beth_can_CA3", _hoc_beth,
 "efun_can_CA3", _hoc_efun,
 "ghk_can_CA3", _hoc_ghk,
 "h2_can_CA3", _hoc_h2,
 "rates_can_CA3", _hoc_rates,
 0, 0
};
#define KTF KTF_can_CA3
#define alpmt alpmt_can_CA3
#define alpm alpm_can_CA3
#define alph alph_can_CA3
#define betmt betmt_can_CA3
#define betm betm_can_CA3
#define beth beth_can_CA3
#define efun efun_can_CA3
#define ghk ghk_can_CA3
#define h2 h2_can_CA3
...
#define a0m a0m_can_CA3
 double a0m = 0.03;
#define gmm gmm_can_CA3
 double gmm = 0.1;
#define hinf hinf_can_CA3
 double hinf = 0;
#define hmin hmin_can_CA3
 double hmin = 3;
#define ki ki_can_CA3
 double ki = 0.001;
#define minf minf_can_CA3
 double minf = 0;
#define mmin mmin_can_CA3
 double mmin = 0.2;
#define q10 q10_can_CA3
 double q10 = 5;
#define tauh tauh_can_CA3
 double tauh = 0;
#define taum taum_can_CA3
 double taum = 0;
#define vhalfm vhalfm_can_CA3
 double vhalfm = -14;
#define zetam zetam_can_CA3
 double zetam = 2;
 ...
 "ki_can_CA3", "mM",
 "gcanbar_can_CA3", "mho/cm2",
 "ica_can_CA3", "mA/cm2",
 "gcan_can_CA3", "mho/cm2",
 0,0
};
 ...
 "ki_can_CA3", &ki_can_CA3,
 "q10_can_CA3", &q10_can_CA3,
 "mmin_can_CA3", &mmin_can_CA3,
 "hmin_can_CA3", &hmin_can_CA3,
 "a0m_can_CA3", &a0m_can_CA3,
 "zetam_can_CA3", &zetam_can_CA3,
 "vhalfm_can_CA3", &vhalfm_can_CA3,
 "gmm_can_CA3", &gmm_can_CA3,
 "minf_can_CA3", &minf_can_CA3,
 "hinf_can_CA3", &hinf_can_CA3,
 "taum_can_CA3", &taum_can_CA3,
 "tauh_can_CA3", &tauh_can_CA3,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 can_CA3 /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/can2_CA3.mod\n");
 ...
 v=_v;
{
  ...
  cao = _ion_cao;
 { error =  states();
 if(error){fprintf(stderr,"at line 58 in file can2_CA3.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/can2_CA3.mod";
static const char* nmodl_file_text = 
