...
#define ica _p[16]
#define cai _p[17]
#define last_ipump _p[18]
#define Dca (_p + 19)
#define DCaBuffer (_p + 23)
#define DBuffer (_p + 27)
#define Dpump _p[31]
#define Dpumpca _p[32]
#define _g _p[33]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "coord_cadifus", _hoc_coord,
 0, 0
};
 /* declare global and static user variables */
#define Buffer0 Buffer0_cadifus
 double Buffer0 = 0;
#define DFree DFree_cadifus
 double DFree = 0.6;
#define k4 k4_cadifus
 double k4 = 5e+06;
#define k3 k3_cadifus
 double k3 = 1e+10;
#define k2 k2_cadifus
 double k2 = 5e+08;
#define k1 k1_cadifus
 double k1 = 1e+10;
#define k2buf k2buf_cadifus
 double k2buf = 0.5;
#define k1buf k1buf_cadifus
 double k1buf = 500;
#define vol vol_cadifus
 double vol[4];
 ...
 "CaBuffer_cadifus", "mM",
 "Buffer_cadifus", "mM",
 "pump_cadifus", "mol/cm2",
 "pumpca_cadifus", "mol/cm2",
 "ipump_cadifus", "mA/cm2",
 0,0
};
 ...
 "DFree_cadifus", &DFree_cadifus,
 "k1buf_cadifus", &k1buf_cadifus,
 "k2buf_cadifus", &k2buf_cadifus,
 "k1_cadifus", &k1_cadifus,
 "k2_cadifus", &k2_cadifus,
 "k3_cadifus", &k3_cadifus,
 "k4_cadifus", &k4_cadifus,
 "Buffer0_cadifus", &Buffer0_cadifus,
 0,0
};
 static DoubVec hoc_vdoub[] = {
 "vol_cadifus", vol_cadifus, 4,
 0,0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
...
#endif
  hoc_register_prop_size(_mechtype, 34, 8);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "area");
 	...
 	ivoc_help("help ?1 cadifus /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/cadiv.mod\n");
 ...
 static double _ztotpump , _zkd , _ztotbuf ;
 ...
 t = 0.0;
{
 ...
 {
   _ztotpump = 0.2 ;
   pump = _ztotpump / ( 1.0 + 1.e-18 * k4 * cao / k3 ) ;
   pumpca = 2.e-22 ;
   ipump = 0.0 ;
   _ztotbuf = 1.2 ;
   _zkd = k2buf / k1buf ;
   {int  _li ;for ( _li = 0 ; _li <= 4 - 1 ; _li ++ ) {
     ca [ _li ] = cai ;
     CaBuffer [ _li ] = ( _ztotbuf * ca [ _li ] ) / ( _zkd + ca [ _li ] ) ;
     Buffer [ _li ] = _ztotbuf - CaBuffer [ _li ] ;
     } }
   }
 {
   if ( _zcoord_done  == 0.0 ) {
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 79 in file cadiv.mod:\n	SOLVE state METHOD sparse\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 14; ++_i) {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/cadiv.mod";
static const char* nmodl_file_text = 
