...
#define nrn_init _nrn_init__cal2
#define _nrn_initial _nrn_initial__cal2
#define nrn_cur _nrn_cur__cal2
#define _nrn_current _nrn_current__cal2
#define nrn_jacob _nrn_jacob__cal2
#define nrn_state _nrn_state__cal2
#define _net_receive _net_receive__cal2 
#define rate rate__cal2 
#define state state__cal2 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cal2", _hoc_setdata,
 "KTF_cal2", _hoc_KTF,
 "alpmt_cal2", _hoc_alpmt,
 "alp_cal2", _hoc_alp,
 "betmt_cal2", _hoc_betmt,
 "bet_cal2", _hoc_bet,
 "efun_cal2", _hoc_efun,
 "ghk_cal2", _hoc_ghk,
 "h2_cal2", _hoc_h2,
...
#define KTF KTF_cal2
#define alpmt alpmt_cal2
#define alp alp_cal2
#define betmt betmt_cal2
#define bet bet_cal2
#define efun efun_cal2
#define ghk ghk_cal2
#define h2 h2_cal2
...
#define ki ki_cal2
 double ki = 0.001;
#define minf minf_cal2
 double minf = 0;
#define mmin mmin_cal2
 double mmin = 0.2;
#define q10 q10_cal2
 double q10 = 5;
#define tau tau_cal2
...
#define tfa tfa_cal2
 double tfa = 1;
#define vhalfm vhalfm_cal2
 double vhalfm = 4;
#define zetam zetam_cal2
 double zetam = 2;
 ...
 "tfa_cal2", &tfa_cal2,
 "a0m_cal2", &a0m_cal2,
 "zetam_cal2", &zetam_cal2,
 "vhalfm_cal2", &vhalfm_cal2,
 "gmm_cal2", &gmm_cal2,
 "minf_cal2", &minf_cal2,
 "tau_cal2", &tau_cal2,
 0,0
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 cal2 /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/cal2.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/cal2.mod";
static const char* nmodl_file_text = 
