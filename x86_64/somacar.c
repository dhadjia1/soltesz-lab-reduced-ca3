...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "calcg_somacar", _hoc_calcg,
 "mhn_somacar", _hoc_mhn,
 "states_somacar", _hoc_states,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "ca_ion");
 	...
 	ivoc_help("help ?1 somacar /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/somacar.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("somacar", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  states();
 if(error){fprintf(stderr,"at line 40 in file somacar.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/somacar.mod";
static const char* nmodl_file_text = 
