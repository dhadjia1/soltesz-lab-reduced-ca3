...
#define nrn_init _nrn_init__STDPE2ASYM
#define _nrn_initial _nrn_initial__STDPE2ASYM
#define nrn_cur _nrn_cur__STDPE2ASYM
#define _nrn_current _nrn_current__STDPE2ASYM
#define nrn_jacob _nrn_jacob__STDPE2ASYM
#define nrn_state _nrn_state__STDPE2ASYM
#define _net_receive _net_receive__STDPE2ASYM 
#define state state__STDPE2ASYM 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 add_nrn_fornetcons(_mechtype, _fnc_index);
 	...
 	ivoc_help("help ?1 STDPE2ASYM /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/STDPE2_asym.mod\n");
...
{  double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt;
 ...
 _args[2] = t ;
     if ( on  == 1.0 ) {
       _args[1] = _args[1] - p * exp ( ( tpost - t ) / dtau ) ;
       if ( _args[0] + _args[1] < 0.0 ) {
         _args[1] = - _args[0] ;
         }
       }
     }
 ...
 {
       _fnargs1[1] = _fnargs1[1] + p * exp ( ( _fnargs1[2] - t ) / ptau ) ;
       if ( _fnargs1[0] + _fnargs1[1] >= wmax ) {
         _fnargs1[1] = wmax - _fnargs1[0] ;
         }
       }
     	}}
 }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/STDPE2_asym.mod";
static const char* nmodl_file_text = 
