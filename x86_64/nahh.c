...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nahh /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/nahh.mod\n");
...
double alp (  double _lv , double _li ) {
 ...
 _lv = _lv + 65.0 ;
   ...
   if ( _li  == 0.0 ) {
     ...
     _lalp = _lq10 * .128 * exp ( ( 17.0 - _lv ) / 18.0 ) ;
     }
 ...
 v=_v;
{
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 38 in file nahh.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/nahh.mod";
static const char* nmodl_file_text = 
  "TITLE nahh \n"
