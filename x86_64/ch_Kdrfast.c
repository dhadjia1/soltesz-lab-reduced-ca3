...
#define nrn_init _nrn_init__ch_Kdrfast
#define _nrn_initial _nrn_initial__ch_Kdrfast
#define nrn_cur _nrn_cur__ch_Kdrfast
#define _nrn_current _nrn_current__ch_Kdrfast
#define nrn_jacob _nrn_jacob__ch_Kdrfast
#define nrn_state _nrn_state__ch_Kdrfast
#define _net_receive _net_receive__ch_Kdrfast 
#define _f_trates _f_trates__ch_Kdrfast 
#define rates rates__ch_Kdrfast 
#define states states__ch_Kdrfast 
#define trates trates__ch_Kdrfast 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_ch_Kdrfast", _hoc_setdata,
 "rates_ch_Kdrfast", _hoc_rates,
 "states_ch_Kdrfast", _hoc_states,
 "trates_ch_Kdrfast", _hoc_trates,
 "vtrap_ch_Kdrfast", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_ch_Kdrfast
 extern double vtrap( double , double );
 /* declare global and static user variables */
#define usetable usetable_ch_Kdrfast
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_ch_Kdrfast", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gmax_ch_Kdrfast", "mho/cm2",
 "g_ch_Kdrfast", "mho/cm2",
 "ik_ch_Kdrfast", "mA/cm2",
 "ntau_ch_Kdrfast", "ms",
 "myi_ch_Kdrfast", "mA/cm2",
 0,0
};
 ...
 "usetable_ch_Kdrfast", &usetable_ch_Kdrfast,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "k_ion");
 	...
 	ivoc_help("help ?1 ch_Kdrfast /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/ch_Kdrfast.mod\n");
...
static int _reset;
static char *modelname = "Fast delayed rectifier potassium channel (voltage dependent)";
...
static int _ode_count(int _type){ hoc_execerror("ch_Kdrfast", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 70 in file ch_Kdrfast.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/ch_Kdrfast.mod";
static const char* nmodl_file_text = 
