...
#define nrn_init _nrn_init__cacum_CA3
#define _nrn_initial _nrn_initial__cacum_CA3
#define nrn_cur _nrn_cur__cacum_CA3
#define _nrn_current _nrn_current__cacum_CA3
#define nrn_jacob _nrn_jacob__cacum_CA3
#define nrn_state _nrn_state__cacum_CA3
#define _net_receive _net_receive__cacum_CA3 
#define integrate integrate__cacum_CA3 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cacum_CA3", _hoc_setdata,
 0, 0
};
...
#define _gth 4
#define irest_cacum_CA3 _thread1data[0]
#define irest _thread[_gth]._pval[0]
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "irest_cacum_CA3", "mA/cm2",
 "depth_cacum_CA3", "um",
 "tau_cacum_CA3", "ms",
 "cai0_cacum_CA3", "mM",
 "i_cacum_CA3", "mA/cm2",
 ...
 "irest_cacum_CA3", &irest_cacum_CA3,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cacum_CA3 /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/cacumm_CA3.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/cacumm_CA3.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
