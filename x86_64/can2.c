...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 can /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/can2.mod\n");
...
static int  rates (  double _lv ) {
 ...
 _la = alpm ( _threadargscomma_ _lv ) ;
   taum = 1.0 / ( _la + betm ( _threadargscomma_ _lv ) ) ;
   minf = _la * taum ;
   _la = alph ( _threadargscomma_ _lv ) ;
   tauh = 1.0 / ( _la + beth ( _threadargscomma_ _lv ) ) ;
   hinf = _la * tauh ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/can2.mod";
static const char* nmodl_file_text = 
