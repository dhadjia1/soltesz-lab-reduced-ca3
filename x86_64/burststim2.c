...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 BurstStim2 /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/burststim2.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "burststim2";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/burststim2.mod";
static const char* nmodl_file_text = 
  "TITLE burststim2\n"
  ": Yup\n"
  "\n"
