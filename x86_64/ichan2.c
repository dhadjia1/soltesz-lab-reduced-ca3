...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
...
#endif
  hoc_register_prop_size(_mechtype, 37, 10);
  ...
  hoc_register_dparam_semantics(_mechtype, 9, "cvodeieq");
 	...
 	ivoc_help("help ?1 ichan2 /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/ichan2.mod\n");
...
static void _initlists(){
 ...
 _slist1[2] = &(nf) - _p;  _dlist1[2] = &(Dnf) - _p;
 _slist1[3] = &(ns) - _p;  _dlist1[3] = &(Dns) - _p;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/ichan2.mod";
static const char* nmodl_file_text = 
  "TITLE ichan2.mod  \n"
  " \n"
  "COMMENT\n"
