...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
 	...
 	ivoc_help("help ?1 cagk /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/cagk.mod\n");
...
double exp1 ( _threadargsprotocomma_ double _lk , double _ld , double _lv ) {
   double _lexp1;
 _lexp1 = _lk * exp ( - 2.0 * _ld * 96.485309 * _lv / 8.313424 / ( 273.15 + celsius ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/cagk.mod";
static const char* nmodl_file_text = 
  "TITLE CaGk\n"
