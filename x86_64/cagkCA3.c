...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "k_ion");
 	...
 	ivoc_help("help ?1 mykca /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/cagkCA3.mod\n");
 ...
 v=_v;
{
  ...
  ek = _ion_ek;
 { error =  state();
 if(error){fprintf(stderr,"at line 64 in file cagkCA3.mod:\n	SOLVE state\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/cagkCA3.mod";
static const char* nmodl_file_text = 
  "TITLE CaGk\n"
