...
#define _f_rates _f_rates__Ih 
#define deriv deriv__Ih 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Ih /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/Ih.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/Ih.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
