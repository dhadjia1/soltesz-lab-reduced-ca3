...
#define nrn_init _nrn_init__cagk_CA3
#define _nrn_initial _nrn_initial__cagk_CA3
#define nrn_cur _nrn_cur__cagk_CA3
#define _nrn_current _nrn_current__cagk_CA3
#define nrn_jacob _nrn_jacob__cagk_CA3
#define nrn_state _nrn_state__cagk_CA3
#define _net_receive _net_receive__cagk_CA3 
#define rate rate__cagk_CA3 
#define state state__cagk_CA3 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cagk_CA3", _hoc_setdata,
 "alp_cagk_CA3", _hoc_alp,
 "bet_cagk_CA3", _hoc_bet,
 "exp1_cagk_CA3", _hoc_exp1,
 "rate_cagk_CA3", _hoc_rate,
 0, 0
};
#define alp alp_cagk_CA3
#define bet bet_cagk_CA3
#define exp1 exp1_cagk_CA3
 extern double alp( double , double );
 extern double bet( double , double );
 extern double exp1( double , double , double );
 /* declare global and static user variables */
#define abar abar_cagk_CA3
 double abar = 0.28;
#define bbar bbar_cagk_CA3
 double bbar = 0.48;
#define d2 d2_cagk_CA3
 double d2 = 1;
#define d1 d1_cagk_CA3
 double d1 = 0.84;
#define k2 k2_cagk_CA3
 double k2 = 1.3e-07;
#define k1 k1_cagk_CA3
 double k1 = 0.00048;
#define oinf oinf_cagk_CA3
 double oinf = 0;
#define st st_cagk_CA3
 double st = 1;
#define tau tau_cagk_CA3
 double tau = 0;
 ...
 "st_cagk_CA3", "1",
 "tau_cagk_CA3", "ms",
 "gbar_cagk_CA3", "mho/cm2",
 "ik_cagk_CA3", "mA/cm2",
 "gkca_cagk_CA3", "mho/cm2",
 0,0
};
 ...
 "d1_cagk_CA3", &d1_cagk_CA3,
 "d2_cagk_CA3", &d2_cagk_CA3,
 "k1_cagk_CA3", &k1_cagk_CA3,
 "k2_cagk_CA3", &k2_cagk_CA3,
 "abar_cagk_CA3", &abar_cagk_CA3,
 "bbar_cagk_CA3", &bbar_cagk_CA3,
 "st_cagk_CA3", &st_cagk_CA3,
 "oinf_cagk_CA3", &oinf_cagk_CA3,
 "tau_cagk_CA3", &tau_cagk_CA3,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 cagk_CA3 /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/cagk_CA3.mod\n");
 ...
 v=_v;
{
  ...
  ek = _ion_ek;
 { error =  state();
 if(error){fprintf(stderr,"at line 60 in file cagk_CA3.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/cagk_CA3.mod";
static const char* nmodl_file_text = 
  "TITLE CaGk\n"
