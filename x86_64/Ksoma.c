...
#define _f_evaluate_fct _f_evaluate_fct__Ksoma 
#define evaluate_fct evaluate_fct__Ksoma 
#define states states__Ksoma 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "Exp_Ksoma", _hoc_Exp,
 "evaluate_fct_Ksoma", _hoc_evaluate_fct,
 "states_Ksoma", _hoc_states,
 "vtrap_Ksoma", _hoc_vtrap,
 0, 0
};
#define Exp Exp_Ksoma
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "k_ion");
 	...
 	ivoc_help("help ?1 Ksoma /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/Ksoma.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("Ksoma", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 43 in file Ksoma.mod:\n        SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/Ksoma.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
