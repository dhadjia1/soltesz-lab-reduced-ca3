...
#define nrn_init _nrn_init__ichan2vip
#define _nrn_initial _nrn_initial__ichan2vip
#define nrn_cur _nrn_cur__ichan2vip
#define _nrn_current _nrn_current__ichan2vip
#define nrn_jacob _nrn_jacob__ichan2vip
#define nrn_state _nrn_state__ichan2vip
#define _net_receive _net_receive__ichan2vip 
#define _f_trates _f_trates__ichan2vip 
#define rates rates__ichan2vip 
#define states states__ichan2vip 
#define trates trates__ichan2vip 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_ichan2vip", _hoc_setdata,
 "rates_ichan2vip", _hoc_rates,
 "states_ichan2vip", _hoc_states,
 "trates_ichan2vip", _hoc_trates,
 "vtrap_ichan2vip", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_ichan2vip
 extern double vtrap( double , double );
 /* declare global and static user variables */
#define usetable usetable_ichan2vip
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_ichan2vip", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gnatbar_ichan2vip", "mho/cm2",
 "gkfbar_ichan2vip", "mho/cm2",
 "gksbar_ichan2vip", "mho/cm2",
 "gl_ichan2vip", "mho/cm2",
 "el_ichan2vip", "mV",
 "gnat_ichan2vip", "mho/cm2",
 "gkf_ichan2vip", "mho/cm2",
 "gks_ichan2vip", "mho/cm2",
 "inat_ichan2vip", "mA/cm2",
 "ikf_ichan2vip", "mA/cm2",
 "iks_ichan2vip", "mA/cm2",
 "il_ichan2vip", "mA/cm2",
 "mtau_ichan2vip", "ms",
 "htau_ichan2vip", "ms",
 "nftau_ichan2vip", "ms",
 ...
 "usetable_ichan2vip", &usetable_ichan2vip,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 8, "ks_ion");
 	...
 	ivoc_help("help ?1 ichan2vip /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/ichan2vip.mod\n");
...
static int _reset;
static char *modelname = "ichan2vip.mod  ";
...
static int  rates (  double _lv ) {
 ...
 _zq10 = 1.0 ;
   _lalpha = - 0.3 * vtrap ( _threadargscomma_ ( _lv + 41.5 ) , - 5.0 ) ;
   _lbeta = 0.3 * vtrap ( _threadargscomma_ ( _lv + 25.0 ) , 5.0 ) ;
   _lsum = _lalpha + _lbeta ;
   mtau = 1.0 / _lsum ;
   minf = _lalpha / _lsum ;
   _lalpha = 0.23 / exp ( ( _lv + 65.0 ) / 20.0 ) ;
   _lbeta = 3.33 / ( 1.0 + exp ( ( _lv + 37.5 ) / - 10.0 ) ) ;
   _lsum = _lalpha + _lbeta ;
   htau = 1.0 / _lsum ;
   hinf = _lalpha / _lsum ;
   _lalpha = - 0.88 * vtrap ( _threadargscomma_ ( _lv + 30.0 ) , - 6.0 ) ;
   _lbeta = 0.1056 / exp ( ( _lv + 55.0 ) / 40.0 ) ;
   _lsum = _lalpha + _lbeta ;
   nstau = 1.0 / _lsum ;
   nsinf = _lalpha / _lsum ;
   _lalpha = - 0.065 * vtrap ( _threadargscomma_ ( _lv + 18.0 ) , - 6.0 ) ;
   _lbeta = 0.264 / exp ( ( _lv + 28.0 ) / 40.0 ) ;
   _lsum = _lalpha + _lbeta ;
   nftau = 1.0 / _lsum ;
   nfinf = _lalpha / _lsum ;
    return 0; }
...
static int _ode_count(int _type){ hoc_execerror("ichan2vip", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  ...
  eks = _ion_eks;
 { error =  states();
 if(error){fprintf(stderr,"at line 72 in file ichan2vip.mod:\n    SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 }   }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/ichan2vip.mod";
static const char* nmodl_file_text = 
  "TITLE ichan2vip.mod  \n"
  " \n"
  "COMMENT\n"
