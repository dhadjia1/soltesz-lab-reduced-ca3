...
#define _f_evaluate_fct _f_evaluate_fct__Nasoma 
#define evaluate_fct evaluate_fct__Nasoma 
#define states states__Nasoma 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "Exp_Nasoma", _hoc_Exp,
 "evaluate_fct_Nasoma", _hoc_evaluate_fct,
 "states_Nasoma", _hoc_states,
 "vtrap_Nasoma", _hoc_vtrap,
 0, 0
};
#define Exp Exp_Nasoma
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "na_ion");
 	...
 	ivoc_help("help ?1 Nasoma /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/Nasoma.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("Nasoma", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 84 in file Nasoma.mod:\n        SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/Nasoma.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
