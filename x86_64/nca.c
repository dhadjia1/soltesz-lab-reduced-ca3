...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nca /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/nca.mod\n");
...
/*CVODE*/
 ...
 static int states (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) { {
   trates ( _threadargscomma_ v ) ;
    ...
    d = d + (1. - exp(dt*(( ( ( - 1.0 ) ) ) / dtau)))*(- ( ( ( dinf ) ) / dtau ) / ( ( ( ( - 1.0 ) ) ) / dtau ) - d) ;
   }
  return 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/nca.mod";
static const char* nmodl_file_text = 
  "TITLE nca.mod  \n"
  " \n"
  "COMMENT\n"
