...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 add_nrn_fornetcons(_mechtype, _fnc_index);
 	...
 	ivoc_help("help ?1 STDPE2 /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/STDPE2.mod\n");
...
{  double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt;
 ...
 _args[2] = t ;
     if ( on  == 1.0 ) {
       _args[1] = _args[1] + p * exp ( ( tpost - t ) / ptau ) ;
       if ( _args[0] + _args[1] >= wmax ) {
         _args[1] = wmax - _args[0] ;
         }
       }
     }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/STDPE2.mod";
static const char* nmodl_file_text = 
