...
#define nrn_init _nrn_init__ichan2bs
#define _nrn_initial _nrn_initial__ichan2bs
#define nrn_cur _nrn_cur__ichan2bs
#define _nrn_current _nrn_current__ichan2bs
#define nrn_jacob _nrn_jacob__ichan2bs
#define nrn_state _nrn_state__ichan2bs
#define _net_receive _net_receive__ichan2bs 
#define _f_trates _f_trates__ichan2bs 
#define rates rates__ichan2bs 
#define states states__ichan2bs 
#define trates trates__ichan2bs 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_ichan2bs", _hoc_setdata,
 "rates_ichan2bs", _hoc_rates,
 "states_ichan2bs", _hoc_states,
 "trates_ichan2bs", _hoc_trates,
 "vtrap_ichan2bs", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_ichan2bs
 extern double vtrap( double , double );
 /* declare global and static user variables */
#define usetable usetable_ichan2bs
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_ichan2bs", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gnatbar_ichan2bs", "mho/cm2",
 "gkfbar_ichan2bs", "mho/cm2",
 "gksbar_ichan2bs", "mho/cm2",
 "gl_ichan2bs", "mho/cm2",
 "el_ichan2bs", "mV",
 "gnat_ichan2bs", "mho/cm2",
 "gkf_ichan2bs", "mho/cm2",
 "gks_ichan2bs", "mho/cm2",
 "inat_ichan2bs", "mA/cm2",
 "ikf_ichan2bs", "mA/cm2",
 "iks_ichan2bs", "mA/cm2",
 "il_ichan2bs", "mA/cm2",
 "mtau_ichan2bs", "ms",
 ...
 "usetable_ichan2bs", &usetable_ichan2bs,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 8, "ks_ion");
 	...
 	ivoc_help("help ?1 ichan2bs /home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/x86_64/ichan2bs.mod\n");
...
static int _reset;
static char *modelname = "ichan2bsZ.mod  ";
...
static int  rates (  double _lv ) {
 ...
 _zq10 = 1.0 ;
   _lalpha = - 0.2 * vtrap ( _threadargscomma_ ( _lv + 27.5 ) , - 5.0 ) ;
   _lbeta = 0.5 * vtrap ( _threadargscomma_ ( _lv + 15.0 + 10.0 ) , 5.0 ) ;
   _lsum = _lalpha + _lbeta ;
   mtau = 1.0 / _lsum ;
   minf = _lalpha / _lsum ;
   _lalpha = 0.23 / exp ( ( _lv + 65.0 ) / 20.0 ) ;
   _lbeta = 2.00 / ( 1.0 + exp ( ( _lv + 12.5 ) / - 10.0 ) ) ;
   _lsum = _lalpha + _lbeta ;
   htau = 1.0 / _lsum ;
   hinf = _lalpha / _lsum ;
   _lalpha = - 0.028 * vtrap ( _threadargscomma_ ( _lv + 34.0 ) , - 6.0 ) ;
   _lbeta = 0.1056 / exp ( ( _lv + 55.0 ) / 40.0 ) ;
   _lsum = _lalpha + _lbeta ;
   nstau = 1.0 / _lsum ;
   nsinf = _lalpha / _lsum ;
   _lalpha = - 0.07 * vtrap ( _threadargscomma_ ( _lv + 18.5 ) , - 6.0 ) ;
   _lbeta = 0.264 / exp ( ( _lv + 5.0 ) / 40.0 ) ;
   _lsum = _lalpha + _lbeta ;
   nftau = 1.0 / _lsum ;
   nfinf = _lalpha / _lsum ;
    return 0; }
...
static int _ode_count(int _type){ hoc_execerror("ichan2bs", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  ...
  eks = _ion_eks;
 { error =  states();
 if(error){fprintf(stderr,"at line 72 in file ichan2bs.mod:\n        \n"); nrn_complain(_p); abort_run(error);}
 }   }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dhh/soltesz-lab/losonczy-ca3-collab/v2-3232021/ichan2bs.mod";
static const char* nmodl_file_text = 
  "TITLE ichan2bsZ.mod  \n"
  " \n"
  "COMMENT\n"
